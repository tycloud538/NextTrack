# Forked and modified from mbdata.models
...
class AlternativeRelease(Base):
    ...
    release_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release.id", "musicbrainz"),
    ...
    artist_credit_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist_credit.id", "musicbrainz"),
    ...
    type_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("alternative_release_type.id", "musicbrainz"),
    ...
    language_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("language.id", "musicbrainz"),
    ...
    script_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("script.id", "musicbrainz"),
    ...
    type = relationship(
        "AlternativeReleaseType", foreign_keys=[type_id], innerjoin=True
    )
...
class AlternativeMedium(Base):
    ...
    medium_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("medium.id", "musicbrainz"),
            name="alternative_medium_fk_medium",
        ),
        nullable=False,
    )
    alternative_release_id = Column(
        "alternative_release",
        Integer,
        ForeignKey(
            apply_schema("alternative_release.id", "musicbrainz"),
    ...
    alternative_release = relationship(
        "AlternativeRelease", foreign_keys=[alternative_release_id], innerjoin=True
    )
...
class AlternativeMediumTrack(Base):
    ...
    alternative_medium_id = Column(
        "alternative_medium",
        Integer,
        ForeignKey(
            apply_schema("alternative_medium.id", "musicbrainz"),
    ...
    track_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("track.id", "musicbrainz"),
            name="alternative_medium_track_fk_track",
        ),
        nullable=False,
        primary_key=True,
    )
    alternative_track_id = Column(
        "alternative_track",
        Integer,
        ForeignKey(
            apply_schema("alternative_track.id", "musicbrainz"),
            name="alternative_medium_track_fk_alternative_track",
        ),
        nullable=False,
    )

    alternative_medium = relationship(
        "AlternativeMedium", foreign_keys=[alternative_medium_id], innerjoin=True
    )
    track = relationship("Track", foreign_keys=[track_id], innerjoin=True)
    alternative_track = relationship(
        "AlternativeTrack", foreign_keys=[alternative_track_id], innerjoin=True
    )
...
class Annotation(Base):
    ...
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="annotation_fk_editor"
        ),
        nullable=False,
    )
    text = Column(String)
...
class Application(Base):
    ...
    owner_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="application_fk_owner"
        ),
        nullable=False,
    )
    name = Column(String, nullable=False)
...
class AreaType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("area_type.id", "musicbrainz"), name="area_type_fk_parent"
        ),
    )
    child_order = Column(
        Integer, nullable=False, default=0, server_default=sql.text("0")
...
class Area(Base):
    ...
    type_id = Column(
        "type",
        Integer,
        ForeignKey(apply_schema("area_type.id", "musicbrainz"), name="area_fk_type"),
    )
...
class AreaGIDRedirect(Base):
    ...
    redirect_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="area_gid_redirect_fk_new_id"
        ),
        nullable=False,
    )
    created = Column(DateTime(timezone=True), server_default=sql.func.now())
...
class AreaAliasType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("area_alias_type.id", "musicbrainz"),
...
class AreaAlias(Base):
    ...
    area_id = Column(
        "area",
        Integer,
        ForeignKey(apply_schema("area.id", "musicbrainz"), name="area_alias_fk_area"),
        nullable=False,
    )
    name = Column(String, nullable=False)
    ...
    type_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("area_alias_type.id", "musicbrainz"), name="area_alias_fk_type"
        ),
    )
...
class AreaAnnotation(Base):
    ...
    area_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="area_annotation_fk_area"
        ),
        nullable=False,
        primary_key=True,
    )
    annotation_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("annotation.id", "musicbrainz"),
    ...
    annotation = relationship(
        "Annotation", foreign_keys=[annotation_id], innerjoin=True
    )
...
class AreaAttributeType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("area_attribute_type.id", "musicbrainz"),
...
class AreaAttributeTypeAllowedValue(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("area_attribute_type_allowed_value.id", "musicbrainz"),
    ...
    area_attribute_type = relationship(
        "AreaAttributeType", foreign_keys=[area_attribute_type_id], innerjoin=True
    )
...
class AreaAttribute(Base):
    ...
    area_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="area_attribute_fk_area"
        ),
        nullable=False,
    )
    area_attribute_type_id = Column(
    ...
    area_attribute_type_allowed_value_id = Column(
    ...
    area_attribute_type_allowed_value = relationship(
...
class AreaContainment(Base):
    ...
    descendant_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"),
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="area_containment_fk_parent"
        ),
        nullable=False,
        primary_key=True,
    )
...
class AreaTag(Base):
    ...
    area_id = Column(
        "area",
        Integer,
        ForeignKey(apply_schema("area.id", "musicbrainz"), name="area_tag_fk_area"),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="area_tag_fk_tag"),
        nullable=False,
        primary_key=True,
    )
...
class AreaTagRaw(Base):
    ...
    area_id = Column(
        "area",
        Integer,
        ForeignKey(apply_schema("area.id", "musicbrainz"), name="area_tag_raw_fk_area"),
        nullable=False,
        primary_key=True,
    )
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="area_tag_raw_fk_editor"
        ),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="area_tag_raw_fk_tag"),
        nullable=False,
        primary_key=True,
    )
...
class Artist(Base):
    ...
    type_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist_type.id", "musicbrainz"), name="artist_fk_type"
        ),
    )
    area_id = Column(
        "area",
        Integer,
        ForeignKey(apply_schema("area.id", "musicbrainz"), name="artist_fk_area"),
    )
    gender_id = Column(
        "gender",
        Integer,
        ForeignKey(apply_schema("gender.id", "musicbrainz"), name="artist_fk_gender"),
    )
    comment = Column(
        String(255), nullable=False, default="", server_default=sql.text("''")
    )
    ...
    last_updated = Column(DateTime(timezone=True), server_default=sql.func.now())
    ended = Column(Boolean, nullable=False, default=False, server_default=sql.false())
    begin_area_id = Column(
        "begin_area",
        Integer,
        ForeignKey(apply_schema("area.id", "musicbrainz"), name="artist_fk_begin_area"),
    )
    end_area_id = Column(
        "end_area",
        Integer,
        ForeignKey(apply_schema("area.id", "musicbrainz"), name="artist_fk_end_area"),
    )
...
class ArtistAliasType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist_alias_type.id", "musicbrainz"),
...
class ArtistAlias(Base):
    ...
    artist_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="artist_alias_fk_artist"
        ),
        nullable=False,
    )
    name = Column(String, nullable=False)
...
class ArtistAnnotation(Base):
    ...
    artist_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="artist_annotation_fk_artist"
        ),
        nullable=False,
        primary_key=True,
    )
...
class ArtistAttributeType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist_attribute_type.id", "musicbrainz"),
...
class ArtistAttributeTypeAllowedValue(Base):
    ...
    id = Column(Integer, primary_key=True)
    artist_attribute_type_id = Column(
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist_attribute_type_allowed_value.id", "musicbrainz"),
    ...
    artist_attribute_type = relationship(
        "ArtistAttributeType", foreign_keys=[artist_attribute_type_id], innerjoin=True
    )
...
class ArtistAttribute(Base):
    ...
    artist_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="artist_attribute_fk_artist"
        ),
        nullable=False,
    )
    artist_attribute_type_id = Column(
    ...
    artist_attribute_type_allowed_value_id = Column(
    ...
    artist_attribute_type_allowed_value = relationship(
        "ArtistAttributeTypeAllowedValue",
        foreign_keys=[artist_attribute_type_allowed_value_id],
    )
...
class ArtistIPI(Base):
    ...
    artist_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="artist_ipi_fk_artist"
        ),
        nullable=False,
        primary_key=True,
    )
    ...
    artist = relationship(
        "Artist", foreign_keys=[artist_id], innerjoin=True, backref=backref("ipis")
    )
...
class ArtistISNI(Base):
    ...
    artist_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="artist_isni_fk_artist"
        ),
        nullable=False,
        primary_key=True,
    )
    ...
    artist = relationship(
        "Artist", foreign_keys=[artist_id], innerjoin=True, backref=backref("isnis")
    )
...
class ArtistMeta(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"),
    ...
    artist = relationship(
        ...
        foreign_keys=[id],
        innerjoin=True,
        backref=backref("meta", uselist=False),
    )
...
class ArtistTag(Base):
    ...
    artist_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="artist_tag_fk_artist"
        ),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="artist_tag_fk_tag"),
        nullable=False,
        primary_key=True,
    )
    count = Column(Integer, nullable=False)
...
class ArtistRatingRaw(Base):
    ...
    artist_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="artist_rating_raw_fk_artist"
        ),
        nullable=False,
        primary_key=True,
    )
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="artist_rating_raw_fk_editor"
        ),
        nullable=False,
        primary_key=True,
    )
...
class ArtistTagRaw(Base):
    ...
    artist_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="artist_tag_raw_fk_artist"
        ),
        nullable=False,
        primary_key=True,
    )
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="artist_tag_raw_fk_editor"
        ),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="artist_tag_raw_fk_tag"),
        nullable=False,
        primary_key=True,
    )
    is_upvote = Column(Boolean, nullable=False, default=True, server_default=sql.true())
...
class ArtistType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist_type.id", "musicbrainz"), name="artist_type_fk_parent"
        ),
    )
    child_order = Column(
        Integer, nullable=False, default=0, server_default=sql.text("0")
...
class ArtistRelease(Base):
    ...
    artist_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="artist_release_fk_artist"
        ),
        nullable=False,
        primary_key=True,
    )
    ...
    release_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release.id", "musicbrainz"), name="artist_release_fk_release"
        ),
        nullable=False,
        primary_key=True,
    )
...
class ArtistReleaseGroup(Base):
    ...
    release_group_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release_group.id", "musicbrainz"),
...
class AutoeditorElection(Base):
    ...
    candidate_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"),
...
class AutoeditorElectionVote(Base):
    ...
    id = Column(Integer, primary_key=True)
    autoeditor_election_id = Column(
        "autoeditor_election",
        Integer,
        ForeignKey(
            apply_schema("autoeditor_election.id", "musicbrainz"),
    ...
    autoeditor_election = relationship(
        "AutoeditorElection", foreign_keys=[autoeditor_election_id], innerjoin=True
    )
...
class CDTOCRaw(Base):
    ...
    release_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release_raw.id", "musicbrainz"), name="cdtoc_raw_fk_release"
        ),
        nullable=False,
    )
    discid = Column(CHAR(28), nullable=False)
...
class CountryArea(Base):
    ...
    area_id = Column(
        "area",
        Integer,
        ForeignKey(apply_schema("area.id", "musicbrainz"), name="country_area_fk_area"),
        primary_key=True,
    )
...
class Edit(Base):
    ...
    editor_id = Column(
        "editor",
        Integer,
        ForeignKey(apply_schema("editor.id", "musicbrainz"), name="edit_fk_editor"),
        nullable=False,
    )
    ...
    language_id = Column(
        "language",
        Integer,
        ForeignKey(apply_schema("language.id", "musicbrainz"), name="edit_fk_language"),
    )
...
class EditData(Base):
    ...
    edit_id = Column(
        "edit",
        Integer,
        ForeignKey(apply_schema("edit.id", "musicbrainz"), name="edit_data_fk_edit"),
        nullable=False,
        primary_key=True,
    )
    data = Column(JSONB, nullable=False)
...
class EditNote(Base):
    ...
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="edit_note_fk_editor"
        ),
        nullable=False,
    )
    edit_id = Column(
        "edit",
        Integer,
        ForeignKey(apply_schema("edit.id", "musicbrainz"), name="edit_note_fk_edit"),
        nullable=False,
    )
...
class EditNoteChange(Base):
    ...
    edit_note_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("edit_note.id", "musicbrainz"),
            name="edit_note_change_fk_edit_note",
        ),
        nullable=False,
    )
    change_editor_id = Column(
        "change_editor",
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"),
    ...
    change_editor = relationship(
        "Editor", foreign_keys=[change_editor_id], innerjoin=True
    )
...
class EditArea(Base):
    ...
    edit_id = Column(
        "edit",
        Integer,
        ForeignKey(apply_schema("edit.id", "musicbrainz"), name="edit_area_fk_edit"),
        nullable=False,
        primary_key=True,
    )
    area_id = Column(
...
class EditArtist(Base):
    ...
    edit_id = Column(
        "edit",
        Integer,
        ForeignKey(apply_schema("edit.id", "musicbrainz"), name="edit_artist_fk_edit"),
        nullable=False,
        primary_key=True,
    )
    artist_id = Column(
...
class EditEvent(Base):
    ...
    edit_id = Column(
        "edit",
        Integer,
        ForeignKey(apply_schema("edit.id", "musicbrainz"), name="edit_event_fk_edit"),
        nullable=False,
        primary_key=True,
    )
    event_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"),
...
class EditGenre(Base):
    ...
    edit_id = Column(
        "edit",
        Integer,
        ForeignKey(apply_schema("edit.id", "musicbrainz"), name="edit_genre_fk_edit"),
        nullable=False,
        primary_key=True,
    )
    genre_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("genre.id", "musicbrainz"),
...
class EditInstrument(Base):
    ...
    edit_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("edit.id", "musicbrainz"), name="edit_instrument_fk_edit"
        ),
        nullable=False,
        primary_key=True,
    )
    instrument_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("instrument.id", "musicbrainz"),
    ...
    instrument = relationship(
        "Instrument", foreign_keys=[instrument_id], innerjoin=True
    )
...
class EditLabel(Base):
    ...
    edit_id = Column(
        "edit",
        Integer,
        ForeignKey(apply_schema("edit.id", "musicbrainz"), name="edit_label_fk_edit"),
        nullable=False,
        primary_key=True,
    )
    label_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"),
...
class EditMood(Base):
    ...
    edit_id = Column(
        "edit",
        Integer,
        ForeignKey(apply_schema("edit.id", "musicbrainz"), name="edit_mood_fk_edit"),
        nullable=False,
        primary_key=True,
    )
    mood_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("mood.id", "musicbrainz"),
...
class EditPlace(Base):
    ...
    edit_id = Column(
        "edit",
        Integer,
        ForeignKey(apply_schema("edit.id", "musicbrainz"), name="edit_place_fk_edit"),
        nullable=False,
        primary_key=True,
    )
    place_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"),
...
class EditRelease(Base):
    ...
    edit_id = Column(
        "edit",
        Integer,
        ForeignKey(apply_schema("edit.id", "musicbrainz"), name="edit_release_fk_edit"),
        nullable=False,
        primary_key=True,
    )
    release_id = Column(
...
class EditReleaseGroup(Base):
    ...
    edit_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("edit.id", "musicbrainz"), name="edit_release_group_fk_edit"
        ),
        nullable=False,
        primary_key=True,
    )
...
class EditRecording(Base):
    ...
    edit_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("edit.id", "musicbrainz"), name="edit_recording_fk_edit"
        ),
        nullable=False,
        primary_key=True,
    )
    recording_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("recording.id", "musicbrainz"),
...
class EditSeries(Base):
    ...
    edit_id = Column(
        "edit",
        Integer,
        ForeignKey(apply_schema("edit.id", "musicbrainz"), name="edit_series_fk_edit"),
        nullable=False,
        primary_key=True,
    )
    series_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"),
...
class EditWork(Base):
    ...
    edit_id = Column(
        "edit",
        Integer,
        ForeignKey(apply_schema("edit.id", "musicbrainz"), name="edit_work_fk_edit"),
        nullable=False,
        primary_key=True,
    )
    work_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"),
...
class EditURL(Base):
    ...
    edit_id = Column(
        "edit",
        Integer,
        ForeignKey(apply_schema("edit.id", "musicbrainz"), name="edit_url_fk_edit"),
        nullable=False,
        primary_key=True,
    )
    url_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("url.id", "musicbrainz"),
...
class Editor(Base):
    ...
    gender_id = Column(
        "gender",
        Integer,
        ForeignKey(apply_schema("gender.id", "musicbrainz"), name="editor_fk_gender"),
    )
    area_id = Column(
        "area",
        Integer,
        ForeignKey(apply_schema("area.id", "musicbrainz"), name="editor_fk_area"),
    )
...
class EditorLanguage(Base):
    ...
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="editor_language_fk_editor"
        ),
        nullable=False,
        primary_key=True,
    )
...
class EditorPreference(Base):
    ...
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="editor_preference_fk_editor"
        ),
        nullable=False,
    )
...
class EditorSubscribeArtist(Base):
    ...
    last_edit_sent_id = Column(
        "last_edit_sent",
        Integer,
        ForeignKey(
            apply_schema("edit.id", "musicbrainz"),
    ...
    editor = relationship("Editor", foreign_keys=[editor_id], innerjoin=True)
    artist = relationship("Artist", foreign_keys=[artist_id], innerjoin=True)
    last_edit_sent = relationship(
        "Edit", foreign_keys=[last_edit_sent_id], innerjoin=True
    )
...
class EditorSubscribeArtistDeleted(Base):
    ...
    gid = Column(
        UUID,
        ForeignKey(
            apply_schema("deleted_entity.gid", "musicbrainz"),
...
class EditorSubscribeCollection(Base):
    ...
    __table_args__ = (
        Index(
            "editor_subscribe_collection_idx_uniq", "editor", "collection", unique=True
        ),
...
class EditorSubscribeEditor(Base):
    ...
    __table_args__ = (
        Index(
            "editor_subscribe_editor_idx_uniq",
            "editor",
            "subscribed_editor",
            unique=True,
        ),
    ...
    editor = relationship("Editor", foreign_keys=[editor_id], innerjoin=True)
    subscribed_editor = relationship(
        "Editor", foreign_keys=[subscribed_editor_id], innerjoin=True
    )
...
class Event(Base):
    ...
    type_id = Column(
        "type",
        Integer,
        ForeignKey(apply_schema("event_type.id", "musicbrainz"), name="event_fk_type"),
    )
    cancelled = Column(
        Boolean, nullable=False, default=False, server_default=sql.false()
    )
...
class EventMeta(Base):
    ...
    rating = Column(SMALLINT)
    rating_count = Column(Integer)
    event_art_presence = Column(
        Enum(
            "absent",
            "present",
            "darkened",
            name="EVENT_ART_PRESENCE",
            schema=mbdata.config.schemas.get("musicbrainz", "musicbrainz"),
        ),
        nullable=False,
        default="absent",
        server_default=sql.text("'absent'"),
    )
...
class EventRatingRaw(Base):
    ...
    event_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="event_rating_raw_fk_event"
        ),
        nullable=False,
        primary_key=True,
    )
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="event_rating_raw_fk_editor"
        ),
        nullable=False,
        primary_key=True,
    )
...
class EventTagRaw(Base):
    ...
    event_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="event_tag_raw_fk_event"
        ),
        nullable=False,
        primary_key=True,
    )
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="event_tag_raw_fk_editor"
        ),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="event_tag_raw_fk_tag"),
        nullable=False,
        primary_key=True,
    )
    is_upvote = Column(Boolean, nullable=False, default=True, server_default=sql.true())
...
class EventAliasType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event_alias_type.id", "musicbrainz"),
...
class EventAlias(Base):
    ...
    event_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="event_alias_fk_event"
        ),
        nullable=False,
    )
    name = Column(String, nullable=False)
...
class EventAnnotation(Base):
    ...
    event_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="event_annotation_fk_event"
        ),
        nullable=False,
        primary_key=True,
    )
...
class EventAttributeType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event_attribute_type.id", "musicbrainz"),
...
class EventAttributeTypeAllowedValue(Base):
    ...
    id = Column(Integer, primary_key=True)
    event_attribute_type_id = Column(
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event_attribute_type_allowed_value.id", "musicbrainz"),
    ...
    event_attribute_type = relationship(
        "EventAttributeType", foreign_keys=[event_attribute_type_id], innerjoin=True
    )
...
class EventAttribute(Base):
    ...
    event_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="event_attribute_fk_event"
        ),
        nullable=False,
    )
    event_attribute_type_id = Column(
    ...
    event_attribute_type_allowed_value_id = Column(
    ...
    event_attribute_type_allowed_value = relationship(
        "EventAttributeTypeAllowedValue",
        foreign_keys=[event_attribute_type_allowed_value_id],
    )
...
class EventGIDRedirect(Base):
    ...
    redirect_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="event_gid_redirect_fk_new_id"
        ),
        nullable=False,
    )
    created = Column(DateTime(timezone=True), server_default=sql.func.now())
...
class EventTag(Base):
    ...
    event_id = Column(
        "event",
        Integer,
        ForeignKey(apply_schema("event.id", "musicbrainz"), name="event_tag_fk_event"),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="event_tag_fk_tag"),
        nullable=False,
        primary_key=True,
    )
    count = Column(Integer, nullable=False)
...
class EventType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event_type.id", "musicbrainz"), name="event_type_fk_parent"
        ),
    )
    child_order = Column(
        Integer, nullable=False, default=0, server_default=sql.text("0")
...
class ReleaseFirstReleaseDate(Base):
    ...
    release = relationship(
        ...
        innerjoin=True,
        backref=backref("first_release", uselist=False),
    )
...
class Gender(Base):
    ...
    parent_id = Column(
        "parent",
        Integer,
        ForeignKey(apply_schema("gender.id", "musicbrainz"), name="gender_fk_parent"),
    )
    child_order = Column(
        Integer, nullable=False, default=0, server_default=sql.text("0")
    )
...
class GenreAliasType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("genre_alias_type.id", "musicbrainz"),
...
class GenreAlias(Base):
    ...
    genre_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("genre.id", "musicbrainz"), name="genre_alias_fk_genre"
        ),
        nullable=False,
    )
    name = Column(String, nullable=False)
...
class GenreAnnotation(Base):
    ...
    genre_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("genre.id", "musicbrainz"), name="genre_annotation_fk_genre"
        ),
        nullable=False,
        primary_key=True,
    )
...
class InstrumentType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("instrument_type.id", "musicbrainz"),
...
class Instrument(Base):
    ...
    type_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("instrument_type.id", "musicbrainz"), name="instrument_fk_type"
        ),
    )
    edits_pending = Column(
        Integer, nullable=False, default=0, server_default=sql.text("0")
...
class InstrumentAliasType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("instrument_alias_type.id", "musicbrainz"),
...
class InstrumentAttributeType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("instrument_attribute_type.id", "musicbrainz"),
...
class InstrumentAttributeTypeAllowedValue(Base):
    ...
    __table_args__ = (
        Index(
            "instrument_attribute_type_allowed_value_idx_name",
    ...
    id = Column(Integer, primary_key=True)
    instrument_attribute_type_id = Column(
        "instrument_attribute_type",
        Integer,
        ForeignKey(
            apply_schema("instrument_attribute_type.id", "musicbrainz"),
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("instrument_attribute_type_allowed_value.id", "musicbrainz"),
    ...
    instrument_attribute_type = relationship(
        "InstrumentAttributeType",
        foreign_keys=[instrument_attribute_type_id],
        innerjoin=True,
    )
    parent = relationship(
        "InstrumentAttributeTypeAllowedValue", foreign_keys=[parent_id]
    )
...
class InstrumentAttribute(Base):
    ...
    instrument_attribute_type_allowed_value_id = Column(
    ...
    instrument_attribute_type_allowed_value = relationship(
        "InstrumentAttributeTypeAllowedValue",
        foreign_keys=[instrument_attribute_type_allowed_value_id],
    )
...
class InstrumentTag(Base):
    ...
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="instrument_tag_fk_tag"),
        nullable=False,
        primary_key=True,
    )
    count = Column(Integer, nullable=False)
...
class InstrumentTagRaw(Base):
    ...
    tag_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("tag.id", "musicbrainz"), name="instrument_tag_raw_fk_tag"
        ),
        nullable=False,
        primary_key=True,
    )
...
class ISO31661(Base):
    ...
    area_id = Column(
        "area",
        Integer,
        ForeignKey(apply_schema("area.id", "musicbrainz"), name="iso_3166_1_fk_area"),
        nullable=False,
    )
    ...
    area = relationship(
        ...
        innerjoin=True,
        backref=backref("iso_3166_1_codes"),
    )
...
class ISO31662(Base):
    ...
    area_id = Column(
        "area",
        Integer,
        ForeignKey(apply_schema("area.id", "musicbrainz"), name="iso_3166_2_fk_area"),
        nullable=False,
    )
    ...
    area = relationship(
        ...
        foreign_keys=[area_id],
        innerjoin=True,
        backref=backref("iso_3166_2_codes"),
    )
...
class ISO31663(Base):
    ...
    area_id = Column(
        "area",
        Integer,
        ForeignKey(apply_schema("area.id", "musicbrainz"), name="iso_3166_3_fk_area"),
        nullable=False,
    )
    ...
    area = relationship(
        ...
        foreign_keys=[area_id],
        innerjoin=True,
        backref=backref("iso_3166_3_codes"),
    )
...
class ISRC(Base):
    ...
    recording_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("recording.id", "musicbrainz"), name="isrc_fk_recording"
        ),
        nullable=False,
    )
...
class ISWC(Base):
    ...
    work_id = Column(
        "work",
        Integer,
        ForeignKey(apply_schema("work.id", "musicbrainz"), name="iswc_fk_work"),
        nullable=False,
    )
    iswc = Column(CHAR(15))
    source = Column(SMALLINT)
    ...
    work = relationship(
        "Work", foreign_keys=[work_id], innerjoin=True, backref=backref("iswcs")
    )
...
class LinkAreaArea(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_area_area_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="l_area_area_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="l_area_area_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkAreaArtist(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_area_artist_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="l_area_artist_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="l_area_artist_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkAreaEvent(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_area_event_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="l_area_event_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="l_area_event_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkAreaGenre(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_area_genre_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="l_area_genre_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("genre.id", "musicbrainz"), name="l_area_genre_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkAreaInstrument(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_area_instrument_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="l_area_instrument_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
...
class LinkAreaLabel(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_area_label_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="l_area_label_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="l_area_label_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkAreaMood(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_area_mood_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="l_area_mood_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("mood.id", "musicbrainz"), name="l_area_mood_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkAreaPlace(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_area_place_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="l_area_place_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="l_area_place_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkAreaRecording(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_area_recording_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="l_area_recording_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
...
class LinkAreaRelease(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_area_release_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="l_area_release_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release.id", "musicbrainz"), name="l_area_release_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkAreaReleaseGroup(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_area_release_group_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkAreaSeries(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_area_series_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="l_area_series_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="l_area_series_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkAreaURL(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_area_url_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="l_area_url_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        "entity1",
        Integer,
        ForeignKey(apply_schema("url.id", "musicbrainz"), name="l_area_url_fk_entity1"),
        nullable=False,
    )
    edits_pending = Column(
        Integer, nullable=False, default=0, server_default=sql.text("0")
...
class LinkAreaWork(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_area_work_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("area.id", "musicbrainz"), name="l_area_work_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="l_area_work_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkArtistArtist(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_artist_artist_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="l_artist_artist_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="l_artist_artist_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkArtistEvent(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_artist_event_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="l_artist_event_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="l_artist_event_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkArtistGenre(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_artist_genre_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="l_artist_genre_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("genre.id", "musicbrainz"), name="l_artist_genre_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkArtistInstrument(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_artist_instrument_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkArtistLabel(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_artist_label_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="l_artist_label_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="l_artist_label_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkArtistMood(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_artist_mood_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="l_artist_mood_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("mood.id", "musicbrainz"), name="l_artist_mood_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkArtistPlace(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_artist_place_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="l_artist_place_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="l_artist_place_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkArtistRecording(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_artist_recording_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkArtistRelease(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_artist_release_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="l_artist_release_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
...
class LinkArtistReleaseGroup(Base):
    ...
    __table_args__ = (
        Index(
            "l_artist_release_group_idx_uniq",
            "entity0",
            "entity1",
            "link",
            "link_order",
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"),
...
class LinkArtistSeries(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_artist_series_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="l_artist_series_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="l_artist_series_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkArtistURL(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_artist_url_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="l_artist_url_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("url.id", "musicbrainz"), name="l_artist_url_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkArtistWork(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_artist_work_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("artist.id", "musicbrainz"), name="l_artist_work_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="l_artist_work_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkEventEvent(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_event_event_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="l_event_event_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="l_event_event_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkEventGenre(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_event_genre_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="l_event_genre_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("genre.id", "musicbrainz"), name="l_event_genre_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkEventInstrument(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_event_instrument_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkEventLabel(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_event_label_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="l_event_label_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="l_event_label_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkEventMood(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_event_mood_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="l_event_mood_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("mood.id", "musicbrainz"), name="l_event_mood_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkEventPlace(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_event_place_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="l_event_place_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="l_event_place_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkEventRecording(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_event_recording_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="l_event_recording_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
...
class LinkEventRelease(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_event_release_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="l_event_release_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release.id", "musicbrainz"), name="l_event_release_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkEventReleaseGroup(Base):
    ...
    __table_args__ = (
        Index(
            "l_event_release_group_idx_uniq",
            "entity0",
            "entity1",
            "link",
            "link_order",
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_event_release_group_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkEventSeries(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_event_series_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="l_event_series_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="l_event_series_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkEventURL(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_event_url_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="l_event_url_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("url.id", "musicbrainz"), name="l_event_url_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkEventWork(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_event_work_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("event.id", "musicbrainz"), name="l_event_work_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="l_event_work_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkLabelLabel(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_label_label_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="l_label_label_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="l_label_label_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkGenreGenre(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_genre_genre_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("genre.id", "musicbrainz"), name="l_genre_genre_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("genre.id", "musicbrainz"), name="l_genre_genre_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkGenreInstrument(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_genre_instrument_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkGenreLabel(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_genre_label_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("genre.id", "musicbrainz"), name="l_genre_label_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="l_genre_label_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkGenreMood(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_genre_mood_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("genre.id", "musicbrainz"), name="l_genre_mood_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("mood.id", "musicbrainz"), name="l_genre_mood_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkGenrePlace(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_genre_place_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("genre.id", "musicbrainz"), name="l_genre_place_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="l_genre_place_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkGenreRecording(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_genre_recording_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("genre.id", "musicbrainz"), name="l_genre_recording_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
...
class LinkGenreRelease(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_genre_release_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("genre.id", "musicbrainz"), name="l_genre_release_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release.id", "musicbrainz"), name="l_genre_release_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkGenreReleaseGroup(Base):
    ...
    __table_args__ = (
        Index(
            "l_genre_release_group_idx_uniq",
            "entity0",
            "entity1",
            "link",
            "link_order",
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_genre_release_group_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkGenreSeries(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_genre_series_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("genre.id", "musicbrainz"), name="l_genre_series_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="l_genre_series_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkGenreURL(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_genre_url_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("genre.id", "musicbrainz"), name="l_genre_url_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("url.id", "musicbrainz"), name="l_genre_url_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkGenreWork(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_genre_work_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("genre.id", "musicbrainz"), name="l_genre_work_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="l_genre_work_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkInstrumentInstrument(Base):
    ...
    __table_args__ = (
        Index(
            "l_instrument_instrument_idx_uniq",
            "entity0",
            "entity1",
            "link",
            "link_order",
...
class LinkInstrumentLabel(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_instrument_label_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkInstrumentMood(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_instrument_mood_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
    ...
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("mood.id", "musicbrainz"), name="l_instrument_mood_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkInstrumentPlace(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_instrument_place_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkInstrumentRecording(Base):
    ...
    __table_args__ = (
        Index(
            "l_instrument_recording_idx_uniq",
            "entity0",
            "entity1",
            "link",
            "link_order",
...
class LinkInstrumentRelease(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_instrument_release_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkInstrumentReleaseGroup(Base):
    ...
    __table_args__ = (
        Index(
            "l_instrument_release_group_idx_uniq",
            "entity0",
            "entity1",
            "link",
            "link_order",
...
class LinkInstrumentSeries(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_instrument_series_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkInstrumentURL(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_instrument_url_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
    ...
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("url.id", "musicbrainz"), name="l_instrument_url_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkInstrumentWork(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_instrument_work_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
    ...
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="l_instrument_work_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkLabelMood(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_label_mood_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="l_label_mood_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("mood.id", "musicbrainz"), name="l_label_mood_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkLabelPlace(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_label_place_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="l_label_place_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="l_label_place_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkLabelRecording(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_label_recording_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="l_label_recording_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
...
class LinkLabelRelease(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_label_release_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="l_label_release_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release.id", "musicbrainz"), name="l_label_release_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkLabelReleaseGroup(Base):
    ...
    __table_args__ = (
        Index(
            "l_label_release_group_idx_uniq",
            "entity0",
            "entity1",
            "link",
            "link_order",
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_label_release_group_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkLabelSeries(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_label_series_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="l_label_series_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="l_label_series_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkLabelURL(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_label_url_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="l_label_url_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("url.id", "musicbrainz"), name="l_label_url_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkLabelWork(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_label_work_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="l_label_work_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="l_label_work_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkMoodMood(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_mood_mood_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("mood.id", "musicbrainz"), name="l_mood_mood_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("mood.id", "musicbrainz"), name="l_mood_mood_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkMoodPlace(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_mood_place_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("mood.id", "musicbrainz"), name="l_mood_place_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="l_mood_place_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkMoodRecording(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_mood_recording_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("mood.id", "musicbrainz"), name="l_mood_recording_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
...
class LinkMoodRelease(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_mood_release_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("mood.id", "musicbrainz"), name="l_mood_release_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release.id", "musicbrainz"), name="l_mood_release_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkMoodReleaseGroup(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_mood_release_group_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkMoodSeries(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_mood_series_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("mood.id", "musicbrainz"), name="l_mood_series_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="l_mood_series_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkMoodURL(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_mood_url_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("mood.id", "musicbrainz"), name="l_mood_url_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        "entity1",
        Integer,
        ForeignKey(apply_schema("url.id", "musicbrainz"), name="l_mood_url_fk_entity1"),
        nullable=False,
    )
    edits_pending = Column(
        Integer, nullable=False, default=0, server_default=sql.text("0")
...
class LinkMoodWork(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_mood_work_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("mood.id", "musicbrainz"), name="l_mood_work_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="l_mood_work_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkPlacePlace(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_place_place_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="l_place_place_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="l_place_place_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkPlaceRecording(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_place_recording_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="l_place_recording_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
...
class LinkPlaceRelease(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_place_release_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="l_place_release_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release.id", "musicbrainz"), name="l_place_release_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkPlaceReleaseGroup(Base):
    ...
    __table_args__ = (
        Index(
            "l_place_release_group_idx_uniq",
            "entity0",
            "entity1",
            "link",
            "link_order",
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_place_release_group_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkPlaceSeries(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_place_series_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="l_place_series_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="l_place_series_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkPlaceURL(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_place_url_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="l_place_url_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("url.id", "musicbrainz"), name="l_place_url_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkPlaceWork(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_place_work_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="l_place_work_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="l_place_work_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkRecordingRecording(Base):
    ...
    __table_args__ = (
        Index(
            "l_recording_recording_idx_uniq",
            "entity0",
            "entity1",
            "link",
            "link_order",
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_recording_recording_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkRecordingRelease(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_recording_release_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkRecordingReleaseGroup(Base):
    ...
    __table_args__ = (
        Index(
            "l_recording_release_group_idx_uniq",
            "entity0",
            "entity1",
            "link",
            "link_order",
...
class LinkRecordingSeries(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_recording_series_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkRecordingURL(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_recording_url_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
    ...
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("url.id", "musicbrainz"), name="l_recording_url_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkRecordingWork(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_recording_work_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
    ...
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="l_recording_work_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkReleaseRelease(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_release_release_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkReleaseReleaseGroup(Base):
    ...
    __table_args__ = (
        Index(
            "l_release_release_group_idx_uniq",
            "entity0",
            "entity1",
            "link",
            "link_order",
...
class LinkReleaseSeries(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_release_series_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
    ...
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="l_release_series_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkReleaseURL(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_release_url_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release.id", "musicbrainz"), name="l_release_url_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("url.id", "musicbrainz"), name="l_release_url_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkReleaseWork(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_release_work_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release.id", "musicbrainz"), name="l_release_work_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="l_release_work_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkReleaseGroupReleaseGroup(Base):
    ...
    __table_args__ = (
        Index(
            "l_release_group_release_group_idx_uniq",
            "entity0",
            "entity1",
            "link",
            "link_order",
...
class LinkReleaseGroupSeries(Base):
    ...
    __table_args__ = (
        Index(
            "l_release_group_series_idx_uniq",
            "entity0",
            "entity1",
            "link",
            "link_order",
...
class LinkReleaseGroupURL(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_release_group_url_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
    ...
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("url.id", "musicbrainz"), name="l_release_group_url_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkReleaseGroupWork(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_release_group_work_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
...
class LinkSeriesSeries(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_series_series_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="l_series_series_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="l_series_series_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkSeriesURL(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_series_url_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="l_series_url_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("url.id", "musicbrainz"), name="l_series_url_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkSeriesWork(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="l_series_work_fk_link"
        ),
        nullable=False,
    )
    entity0_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="l_series_work_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="l_series_work_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkURLURL(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_url_url_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(apply_schema("url.id", "musicbrainz"), name="l_url_url_fk_entity0"),
        nullable=False,
    )
    entity1_id = Column(
        "entity1",
        Integer,
        ForeignKey(apply_schema("url.id", "musicbrainz"), name="l_url_url_fk_entity1"),
        nullable=False,
    )
    edits_pending = Column(
        Integer, nullable=False, default=0, server_default=sql.text("0")
...
class LinkURLWork(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_url_work_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(apply_schema("url.id", "musicbrainz"), name="l_url_work_fk_entity0"),
        nullable=False,
    )
    entity1_id = Column(
        "entity1",
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="l_url_work_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class LinkWorkWork(Base):
    ...
    link_id = Column(
        "link",
        Integer,
        ForeignKey(apply_schema("link.id", "musicbrainz"), name="l_work_work_fk_link"),
        nullable=False,
    )
    entity0_id = Column(
        "entity0",
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="l_work_work_fk_entity0"
        ),
        nullable=False,
    )
    entity1_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="l_work_work_fk_entity1"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class Label(Base):
    ...
    type_id = Column(
        "type",
        Integer,
        ForeignKey(apply_schema("label_type.id", "musicbrainz"), name="label_fk_type"),
    )
    area_id = Column(
        "area",
        Integer,
        ForeignKey(apply_schema("area.id", "musicbrainz"), name="label_fk_area"),
    )
    comment = Column(
        String(255), nullable=False, default="", server_default=sql.text("''")
    )
...
class LabelRatingRaw(Base):
    ...
    label_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="label_rating_raw_fk_label"
        ),
        nullable=False,
        primary_key=True,
    )
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="label_rating_raw_fk_editor"
        ),
        nullable=False,
        primary_key=True,
    )
...
class LabelTagRaw(Base):
    ...
    label_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="label_tag_raw_fk_label"
        ),
        nullable=False,
        primary_key=True,
    )
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="label_tag_raw_fk_editor"
        ),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="label_tag_raw_fk_tag"),
        nullable=False,
        primary_key=True,
    )
    is_upvote = Column(Boolean, nullable=False, default=True, server_default=sql.true())
...
class LabelAliasType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label_alias_type.id", "musicbrainz"),
...
class LabelAlias(Base):
    ...
    label_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="label_alias_fk_label"
        ),
        nullable=False,
    )
    name = Column(String, nullable=False)
...
class LabelAnnotation(Base):
    ...
    label_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="label_annotation_fk_label"
        ),
        nullable=False,
        primary_key=True,
    )
...
class LabelAttributeType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label_attribute_type.id", "musicbrainz"),
...
class LabelAttributeTypeAllowedValue(Base):
    ...
    id = Column(Integer, primary_key=True)
    label_attribute_type_id = Column(
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label_attribute_type_allowed_value.id", "musicbrainz"),
    ...
    label_attribute_type = relationship(
        "LabelAttributeType", foreign_keys=[label_attribute_type_id], innerjoin=True
    )
...
class LabelAttribute(Base):
    ...
    label_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="label_attribute_fk_label"
        ),
        nullable=False,
    )
    label_attribute_type_id = Column(
    ...
    label_attribute_type_allowed_value_id = Column(
    ...
    label_attribute_type_allowed_value = relationship(
        "LabelAttributeTypeAllowedValue",
        foreign_keys=[label_attribute_type_allowed_value_id],
    )
...
class LabelIPI(Base):
    ...
    label_id = Column(
        "label",
        Integer,
        ForeignKey(apply_schema("label.id", "musicbrainz"), name="label_ipi_fk_label"),
        nullable=False,
        primary_key=True,
    )
    ipi = Column(CHAR(11), nullable=False, primary_key=True)
    ...
    label = relationship(
        "Label", foreign_keys=[label_id], innerjoin=True, backref=backref("ipis")
    )
...
class LabelISNI(Base):
    ...
    label_id = Column(
        "label",
        Integer,
        ForeignKey(apply_schema("label.id", "musicbrainz"), name="label_isni_fk_label"),
        nullable=False,
        primary_key=True,
    )
    isni = Column(CHAR(16), nullable=False, primary_key=True)
    ...
    label = relationship(
        "Label", foreign_keys=[label_id], innerjoin=True, backref=backref("isnis")
    )
...
class LabelGIDRedirect(Base):
    ...
    redirect_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="label_gid_redirect_fk_new_id"
        ),
        nullable=False,
    )
    created = Column(DateTime(timezone=True), server_default=sql.func.now())
...
class LabelTag(Base):
    ...
    label_id = Column(
        "label",
        Integer,
        ForeignKey(apply_schema("label.id", "musicbrainz"), name="label_tag_fk_label"),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="label_tag_fk_tag"),
        nullable=False,
        primary_key=True,
    )
    count = Column(Integer, nullable=False)
...
class LabelType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label_type.id", "musicbrainz"), name="label_type_fk_parent"
        ),
    )
    child_order = Column(
        Integer, nullable=False, default=0, server_default=sql.text("0")
...
class Link(Base):
    ...
    link_type_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link_type.id", "musicbrainz"), name="link_fk_link_type"
        ),
        nullable=False,
    )
    begin_date_year = Column(SMALLINT)
...
class LinkAttribute(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="link_attribute_fk_link"
        ),
        nullable=False,
        primary_key=True,
    )
    attribute_type_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link_attribute_type.id", "musicbrainz"),
    ...
    attribute_type = relationship(
        "LinkAttributeType", foreign_keys=[attribute_type_id], innerjoin=True
    )
...
class LinkAttributeCredit(Base):
    ...
    link_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link.id", "musicbrainz"), name="link_attribute_credit_fk_link"
        ),
        nullable=False,
        primary_key=True,
    )
    attribute_type = Column(
        ...
        ForeignKey(
            apply_schema(
                "link_creditable_attribute_type.attribute_type", "musicbrainz"
            ),
...
class LinkAttributeTextValue(Base):
    ...
    attribute_type = Column(
        Integer,
        ForeignKey(
            apply_schema("link_text_attribute_type.attribute_type", "musicbrainz"),
...
class LinkType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link_type.id", "musicbrainz"), name="link_type_fk_parent"
        ),
    )
    child_order = Column(
        Integer, nullable=False, default=0, server_default=sql.text("0")
...
class LinkTypeAttributeType(Base):
    ...
    link_type_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("link_type.id", "musicbrainz"),
...
class EditorCollection(Base):
    ...
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="editor_collection_fk_editor"
        ),
        nullable=False,
    )
    name = Column(String, nullable=False)
    ...
    type_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor_collection_type.id", "musicbrainz"),
...
class EditorCollectionGIDRedirect(Base):
    ...
    redirect_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor_collection.id", "musicbrainz"),
    ...
    redirect = relationship(
        "EditorCollection", foreign_keys=[redirect_id], innerjoin=True
    )
...
class EditorCollectionCollaborator(Base):
    ...
    collection = relationship(
        "EditorCollection", foreign_keys=[collection_id], innerjoin=True
    )
    editor = relationship("Editor", foreign_keys=[editor_id], innerjoin=True)
...
class EditorOauthToken(Base):
    ...
    application_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("application.id", "musicbrainz"),
    ...
    application = relationship(
        "Application", foreign_keys=[application_id], innerjoin=True
    )
...
class Medium(Base):
    ...
    release_id = Column(
        "release",
        Integer,
        ForeignKey(apply_schema("release.id", "musicbrainz"), name="medium_fk_release"),
        nullable=False,
    )
    ...
    format_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("medium_format.id", "musicbrainz"), name="medium_fk_format"
        ),
    )
...
class MediumAttributeType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("medium_attribute_type.id", "musicbrainz"),
...
class MediumAttributeTypeAllowedFormat(Base):
    ...
    medium_format_id = Column(
        "medium_format",
        Integer,
        ForeignKey(
            apply_schema("medium_format.id", "musicbrainz"),
            name="medium_attribute_type_allowed_format_fk_medium_format",
        ),
        nullable=False,
        primary_key=True,
    )
    medium_attribute_type_id = Column(
    ...
    medium_format = relationship(
        "MediumFormat", foreign_keys=[medium_format_id], innerjoin=True
    )
    medium_attribute_type = relationship(
        "MediumAttributeType", foreign_keys=[medium_attribute_type_id], innerjoin=True
    )
...
class MediumAttributeTypeAllowedValue(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("medium_attribute_type_allowed_value.id", "musicbrainz"),
...
class MediumAttributeTypeAllowedValueAllowedFormat(Base):
    ...
    medium_attribute_type_allowed_value_id = Column(
    ...
    medium_attribute_type_allowed_value = relationship(
        "MediumAttributeTypeAllowedValue",
        foreign_keys=[medium_attribute_type_allowed_value_id],
        innerjoin=True,
    )
...
class MediumAttribute(Base):
    ...
    medium_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("medium.id", "musicbrainz"), name="medium_attribute_fk_medium"
        ),
        nullable=False,
    )
    medium_attribute_type_id = Column(
...
class MediumCDTOC(Base):
    ...
    medium_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("medium.id", "musicbrainz"), name="medium_cdtoc_fk_medium"
        ),
        nullable=False,
    )
    cdtoc_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("cdtoc.id", "musicbrainz"), name="medium_cdtoc_fk_cdtoc"
        ),
        nullable=False,
    )
    edits_pending = Column(
...
class MoodAliasType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("mood_alias_type.id", "musicbrainz"),
...
class MoodAlias(Base):
    ...
    mood_id = Column(
        "mood",
        Integer,
        ForeignKey(apply_schema("mood.id", "musicbrainz"), name="mood_alias_fk_mood"),
        nullable=False,
    )
    name = Column(String, nullable=False)
    locale = Column(String)
    ...
    type_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("mood_alias_type.id", "musicbrainz"), name="mood_alias_fk_type"
        ),
    )
    sort_name = Column(String, nullable=False)
    begin_date_year = Column(SMALLINT)
...
class MoodAnnotation(Base):
    ...
    mood_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("mood.id", "musicbrainz"), name="mood_annotation_fk_mood"
        ),
        nullable=False,
        primary_key=True,
    )
...
class Place(Base):
    ...
    type_id = Column(
        "type",
        Integer,
        ForeignKey(apply_schema("place_type.id", "musicbrainz"), name="place_fk_type"),
    )
    address = Column(String, nullable=False, default="", server_default=sql.text("''"))
    area_id = Column(
        "area",
        Integer,
        ForeignKey(apply_schema("area.id", "musicbrainz"), name="place_fk_area"),
    )
...
class PlaceAlias(Base):
    ...
    place_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="place_alias_fk_place"
        ),
        nullable=False,
    )
    name = Column(String, nullable=False)
    ...
    type_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place_alias_type.id", "musicbrainz"),
...
class PlaceAnnotation(Base):
    ...
    place_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="place_annotation_fk_place"
        ),
        nullable=False,
        primary_key=True,
    )
...
class PlaceAttributeType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place_attribute_type.id", "musicbrainz"),
...
class PlaceAttributeTypeAllowedValue(Base):
    ...
    id = Column(Integer, primary_key=True)
    place_attribute_type_id = Column(
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place_attribute_type_allowed_value.id", "musicbrainz"),
    ...
    place_attribute_type = relationship(
        "PlaceAttributeType", foreign_keys=[place_attribute_type_id], innerjoin=True
    )
...
class PlaceAttribute(Base):
    ...
    place_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="place_attribute_fk_place"
        ),
        nullable=False,
    )
    place_attribute_type_id = Column(
    ...
    place_attribute_type_allowed_value_id = Column(
    ...
    place_attribute_type_allowed_value = relationship(
        "PlaceAttributeTypeAllowedValue",
        foreign_keys=[place_attribute_type_allowed_value_id],
    )
...
class PlaceGIDRedirect(Base):
    ...
    redirect_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="place_gid_redirect_fk_new_id"
        ),
        nullable=False,
    )
    created = Column(DateTime(timezone=True), server_default=sql.func.now())
...
class PlaceRatingRaw(Base):
    ...
    place_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="place_rating_raw_fk_place"
        ),
        nullable=False,
        primary_key=True,
    )
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="place_rating_raw_fk_editor"
        ),
        nullable=False,
        primary_key=True,
    )
...
class PlaceTag(Base):
    ...
    place_id = Column(
        "place",
        Integer,
        ForeignKey(apply_schema("place.id", "musicbrainz"), name="place_tag_fk_place"),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="place_tag_fk_tag"),
        nullable=False,
        primary_key=True,
    )
    count = Column(Integer, nullable=False)
...
class PlaceTagRaw(Base):
    ...
    place_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place.id", "musicbrainz"), name="place_tag_raw_fk_place"
        ),
        nullable=False,
        primary_key=True,
    )
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="place_tag_raw_fk_editor"
        ),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="place_tag_raw_fk_tag"),
        nullable=False,
        primary_key=True,
    )
    is_upvote = Column(Boolean, nullable=False, default=True, server_default=sql.true())
...
class PlaceType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("place_type.id", "musicbrainz"), name="place_type_fk_parent"
        ),
    )
    child_order = Column(
        Integer, nullable=False, default=0, server_default=sql.text("0")
...
class RecordingAliasType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("recording_alias_type.id", "musicbrainz"),
...
class RecordingTagRaw(Base):
    ...
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="recording_tag_raw_fk_editor"
        ),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("tag.id", "musicbrainz"), name="recording_tag_raw_fk_tag"
        ),
        nullable=False,
        primary_key=True,
    )
...
class RecordingAttributeType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("recording_attribute_type.id", "musicbrainz"),
...
class RecordingAttributeTypeAllowedValue(Base):
    ...
    __table_args__ = (
        Index(
            "recording_attribute_type_allowed_value_idx_name",
    ...
    id = Column(Integer, primary_key=True)
    recording_attribute_type_id = Column(
        "recording_attribute_type",
        Integer,
        ForeignKey(
            apply_schema("recording_attribute_type.id", "musicbrainz"),
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("recording_attribute_type_allowed_value.id", "musicbrainz"),
    ...
    recording_attribute_type = relationship(
        "RecordingAttributeType",
        foreign_keys=[recording_attribute_type_id],
        innerjoin=True,
    )
    parent = relationship(
        "RecordingAttributeTypeAllowedValue", foreign_keys=[parent_id]
    )
...
class RecordingAttribute(Base):
    ...
    recording_attribute_type_allowed_value_id = Column(
    ...
    recording_attribute_type_allowed_value = relationship(
        "RecordingAttributeTypeAllowedValue",
        foreign_keys=[recording_attribute_type_allowed_value_id],
    )
...
class RecordingTag(Base):
    ...
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="recording_tag_fk_tag"),
        nullable=False,
        primary_key=True,
    )
    count = Column(Integer, nullable=False)
...
class Release(Base):
    ...
    status_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release_status.id", "musicbrainz"), name="release_fk_status"
        ),
    )
    packaging_id = Column(
        "packaging",
        Integer,
        ForeignKey(
            apply_schema("release_packaging.id", "musicbrainz"),
    ...
    language_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("language.id", "musicbrainz"), name="release_fk_language"
        ),
    )
    script_id = Column(
        "script",
        Integer,
        ForeignKey(apply_schema("script.id", "musicbrainz"), name="release_fk_script"),
    )
...
class ReleaseAliasType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release_alias_type.id", "musicbrainz"),
...
class ReleaseAlias(Base):
    ...
    release_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release.id", "musicbrainz"), name="release_alias_fk_release"
        ),
        nullable=False,
    )
    name = Column(String, nullable=False)
...
class ReleaseCountry(Base):
    ...
    release_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release.id", "musicbrainz"), name="release_country_fk_release"
        ),
        nullable=False,
        primary_key=True,
    )
    country_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("country_area.area", "musicbrainz"),
...
class ReleaseUnknownCountry(Base):
    ...
    release = relationship(
        ...
        foreign_keys=[release_id],
        innerjoin=True,
        backref=backref("unknown_country_dates"),
    )
...
class ReleaseTagRaw(Base):
    ...
    release_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release.id", "musicbrainz"), name="release_tag_raw_fk_release"
        ),
        nullable=False,
        primary_key=True,
    )
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="release_tag_raw_fk_editor"
        ),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("tag.id", "musicbrainz"), name="release_tag_raw_fk_tag"
        ),
        nullable=False,
        primary_key=True,
    )
...
class ReleaseAttributeType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release_attribute_type.id", "musicbrainz"),
...
class ReleaseAttributeTypeAllowedValue(Base):
    ...
    __table_args__ = (
        Index(
            "release_attribute_type_allowed_value_idx_name", "release_attribute_type"
        ),
    ...
    id = Column(Integer, primary_key=True)
    release_attribute_type_id = Column(
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release_attribute_type_allowed_value.id", "musicbrainz"),
    ...
    release_attribute_type = relationship(
        "ReleaseAttributeType", foreign_keys=[release_attribute_type_id], innerjoin=True
    )
...
class ReleaseAttribute(Base):
    ...
    release_attribute_type_allowed_value_id = Column(
    ...
    release_attribute_type_allowed_value = relationship(
...
class ReleaseMeta(Base):
    ...
    cover_art_presence = Column(
        Enum(
            "absent",
            "present",
            "darkened",
            name="COVER_ART_PRESENCE",
            schema=mbdata.config.schemas.get("musicbrainz", "musicbrainz"),
        ),
        nullable=False,
        default="absent",
...
class ReleaseLabel(Base):
    ...
    release_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release.id", "musicbrainz"), name="release_label_fk_release"
        ),
        nullable=False,
    )
    label_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("label.id", "musicbrainz"), name="release_label_fk_label"
        ),
    )
    ...
    release = relationship(
        "Release", foreign_keys=[release_id], innerjoin=True, backref=backref("labels")
    )
...
class ReleaseStatus(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release_status.id", "musicbrainz"),
...
class ReleaseTag(Base):
    ...
    release_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release.id", "musicbrainz"), name="release_tag_fk_release"
        ),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="release_tag_fk_tag"),
        nullable=False,
        primary_key=True,
    )
    count = Column(Integer, nullable=False)
...
class ReleaseGroup(Base):
    ...
    type_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release_group_primary_type.id", "musicbrainz"),
...
class ReleaseGroupAliasType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release_group_alias_type.id", "musicbrainz"),
...
class ReleaseGroupAlias(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "release_group_alias_idx_primary", "release_group", "locale", unique=True
        ),
        {"schema": mbdata.config.schemas.get("musicbrainz", "musicbrainz")},
    )
...
class ReleaseGroupTagRaw(Base):
    ...
    tag_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("tag.id", "musicbrainz"), name="release_group_tag_raw_fk_tag"
        ),
        nullable=False,
        primary_key=True,
    )
...
class ReleaseGroupAttributeType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release_group_attribute_type.id", "musicbrainz"),
...
class ReleaseGroupAttributeTypeAllowedValue(Base):
    ...
    __table_args__ = (
        Index(
            "release_group_attribute_type_allowed_value_idx_name",
    ...
    id = Column(Integer, primary_key=True)
    release_group_attribute_type_id = Column(
        "release_group_attribute_type",
        Integer,
        ForeignKey(
            apply_schema("release_group_attribute_type.id", "musicbrainz"),
    ...
    parent_id = Column(
        ...
        ForeignKey(
            apply_schema(
                "release_group_attribute_type_allowed_value.id", "musicbrainz"
            ),
    ...
    release_group_attribute_type = relationship(
        "ReleaseGroupAttributeType",
        foreign_keys=[release_group_attribute_type_id],
        innerjoin=True,
    )
    parent = relationship(
        "ReleaseGroupAttributeTypeAllowedValue", foreign_keys=[parent_id]
    )
...
class ReleaseGroupAttribute(Base):
    ...
    release_group_attribute_type_allowed_value_id = Column(
    ...
    release_group_attribute_type_allowed_value = relationship(
        "ReleaseGroupAttributeTypeAllowedValue",
        foreign_keys=[release_group_attribute_type_allowed_value_id],
    )
...
class ReleaseGroupTag(Base):
    ...
    tag_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("tag.id", "musicbrainz"), name="release_group_tag_fk_tag"
        ),
        nullable=False,
        primary_key=True,
    )
...
class ReleaseGroupSecondaryType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release_group_secondary_type.id", "musicbrainz"),
...
class ReleaseGroupSecondaryTypeJoin(Base):
    ...
    secondary_type = relationship(
        "ReleaseGroupSecondaryType", foreign_keys=[secondary_type_id], innerjoin=True
    )
...
class Series(Base):
    ...
    type_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series_type.id", "musicbrainz"), name="series_fk_type"
        ),
        nullable=False,
    )
    ordering_type_id = Column(
        "ordering_type",
        Integer,
        ForeignKey(
            apply_schema("series_ordering_type.id", "musicbrainz"),
    ...
    ordering_type = relationship(
        "SeriesOrderingType", foreign_keys=[ordering_type_id], innerjoin=True
    )
...
class SeriesType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series_type.id", "musicbrainz"), name="series_type_fk_parent"
        ),
    )
    child_order = Column(
        Integer, nullable=False, default=0, server_default=sql.text("0")
...
class SeriesAliasType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series_alias_type.id", "musicbrainz"),
...
class SeriesAlias(Base):
    ...
    series_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="series_alias_fk_series"
        ),
        nullable=False,
    )
    name = Column(String, nullable=False)
...
class SeriesAnnotation(Base):
    ...
    series_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="series_annotation_fk_series"
        ),
        nullable=False,
        primary_key=True,
    )
...
class SeriesAttributeType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series_attribute_type.id", "musicbrainz"),
...
class SeriesAttributeTypeAllowedValue(Base):
    ...
    id = Column(Integer, primary_key=True)
    series_attribute_type_id = Column(
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series_attribute_type_allowed_value.id", "musicbrainz"),
    ...
    series_attribute_type = relationship(
        "SeriesAttributeType", foreign_keys=[series_attribute_type_id], innerjoin=True
    )
...
class SeriesAttribute(Base):
    ...
    series_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="series_attribute_fk_series"
        ),
        nullable=False,
    )
    series_attribute_type_id = Column(
    ...
    series_attribute_type_allowed_value_id = Column(
    ...
    series_attribute_type_allowed_value = relationship(
        "SeriesAttributeTypeAllowedValue",
        foreign_keys=[series_attribute_type_allowed_value_id],
    )
...
class SeriesTag(Base):
    ...
    series_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="series_tag_fk_series"
        ),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="series_tag_fk_tag"),
        nullable=False,
        primary_key=True,
    )
    count = Column(Integer, nullable=False)
...
class SeriesTagRaw(Base):
    ...
    series_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("series.id", "musicbrainz"), name="series_tag_raw_fk_series"
        ),
        nullable=False,
        primary_key=True,
    )
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="series_tag_raw_fk_editor"
        ),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="series_tag_raw_fk_tag"),
        nullable=False,
        primary_key=True,
    )
    is_upvote = Column(Boolean, nullable=False, default=True, server_default=sql.true())
...
class TagRelation(Base):
    ...
    tag1_id = Column(
        "tag1",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="tag_relation_fk_tag1"),
        nullable=False,
        primary_key=True,
    )
    tag2_id = Column(
        "tag2",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="tag_relation_fk_tag2"),
        nullable=False,
        primary_key=True,
    )
...
class Track(Base):
    ...
    recording_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("recording.id", "musicbrainz"), name="track_fk_recording"
        ),
        nullable=False,
    )
    medium_id = Column(
        "medium",
        Integer,
        ForeignKey(apply_schema("medium.id", "musicbrainz"), name="track_fk_medium"),
        nullable=False,
    )
    position = Column(Integer, nullable=False)
...
class TrackGIDRedirect(Base):
    ...
    redirect_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("track.id", "musicbrainz"), name="track_gid_redirect_fk_new_id"
        ),
        nullable=False,
    )
    created = Column(DateTime(timezone=True), server_default=sql.func.now())
...
class TrackRaw(Base):
    ...
    release_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("release_raw.id", "musicbrainz"), name="track_raw_fk_release"
        ),
        nullable=False,
    )
    title = Column(String(255), nullable=False)
...
class URLGIDRedirect(Base):
    ...
    redirect_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("url.id", "musicbrainz"), name="url_gid_redirect_fk_new_id"
        ),
        nullable=False,
    )
    created = Column(DateTime(timezone=True), server_default=sql.func.now())
...
class Vote(Base):
    ...
    editor_id = Column(
        "editor",
        Integer,
        ForeignKey(apply_schema("editor.id", "musicbrainz"), name="vote_fk_editor"),
        nullable=False,
    )
    edit_id = Column(
        "edit",
        Integer,
        ForeignKey(apply_schema("edit.id", "musicbrainz"), name="vote_fk_edit"),
        nullable=False,
    )
...
class Work(Base):
    ...
    type_id = Column(
        "type",
        Integer,
        ForeignKey(apply_schema("work_type.id", "musicbrainz"), name="work_fk_type"),
    )
    comment = Column(
        String(255), nullable=False, default="", server_default=sql.text("''")
    )
...
class WorkLanguage(Base):
    ...
    work_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="work_language_fk_work"
        ),
        nullable=False,
        primary_key=True,
    )
    language_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("language.id", "musicbrainz"), name="work_language_fk_language"
        ),
        nullable=False,
        primary_key=True,
    )
...
class WorkRatingRaw(Base):
    ...
    work_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="work_rating_raw_fk_work"
        ),
        nullable=False,
        primary_key=True,
    )
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="work_rating_raw_fk_editor"
        ),
        nullable=False,
        primary_key=True,
    )
...
class WorkTagRaw(Base):
    ...
    work_id = Column(
        "work",
        Integer,
        ForeignKey(apply_schema("work.id", "musicbrainz"), name="work_tag_raw_fk_work"),
        nullable=False,
        primary_key=True,
    )
    editor_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("editor.id", "musicbrainz"), name="work_tag_raw_fk_editor"
        ),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="work_tag_raw_fk_tag"),
        nullable=False,
        primary_key=True,
    )
    is_upvote = Column(Boolean, nullable=False, default=True, server_default=sql.true())
...
class WorkAliasType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work_alias_type.id", "musicbrainz"),
...
class WorkAlias(Base):
    ...
    work_id = Column(
        "work",
        Integer,
        ForeignKey(apply_schema("work.id", "musicbrainz"), name="work_alias_fk_work"),
        nullable=False,
    )
    name = Column(String, nullable=False)
    locale = Column(String)
    ...
    type_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work_alias_type.id", "musicbrainz"), name="work_alias_fk_type"
        ),
    )
    sort_name = Column(String, nullable=False)
    begin_date_year = Column(SMALLINT)
...
class WorkAnnotation(Base):
    ...
    work_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="work_annotation_fk_work"
        ),
        nullable=False,
        primary_key=True,
    )
...
class WorkGIDRedirect(Base):
    ...
    redirect_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="work_gid_redirect_fk_new_id"
        ),
        nullable=False,
    )
    created = Column(DateTime(timezone=True), server_default=sql.func.now())
...
class WorkTag(Base):
    ...
    work_id = Column(
        "work",
        Integer,
        ForeignKey(apply_schema("work.id", "musicbrainz"), name="work_tag_fk_work"),
        nullable=False,
        primary_key=True,
    )
    tag_id = Column(
        "tag",
        Integer,
        ForeignKey(apply_schema("tag.id", "musicbrainz"), name="work_tag_fk_tag"),
        nullable=False,
        primary_key=True,
    )
    count = Column(Integer, nullable=False)
...
class WorkType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work_type.id", "musicbrainz"), name="work_type_fk_parent"
        ),
    )
    child_order = Column(
        Integer, nullable=False, default=0, server_default=sql.text("0")
...
class WorkAttributeType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work_attribute_type.id", "musicbrainz"),
...
class WorkAttributeTypeAllowedValue(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work_attribute_type_allowed_value.id", "musicbrainz"),
    ...
    work_attribute_type = relationship(
        "WorkAttributeType", foreign_keys=[work_attribute_type_id], innerjoin=True
    )
...
class WorkAttribute(Base):
    ...
    work_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("work.id", "musicbrainz"), name="work_attribute_fk_work"
        ),
        nullable=False,
    )
    work_attribute_type_id = Column(
    ...
    work_attribute_type_allowed_value_id = Column(
    ...
    work_attribute_type_allowed_value = relationship(
...
class ArtType(Base):
    ...
    parent_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("art_type.id", "cover_art_archive"), name="art_type_fk_parent"
        ),
    )
    child_order = Column(
        Integer, nullable=False, default=0, server_default=sql.text("0")
...
class CoverArt(Base):
    ...
    edit_id = Column(
        "edit",
        Integer,
        ForeignKey(apply_schema("edit.id", "musicbrainz"), name="cover_art_fk_edit"),
        nullable=False,
    )
    ...
    mime_type = Column(
        String,
        ForeignKey(
            apply_schema("image_type.mime_type", "cover_art_archive"),
            name="cover_art_fk_mime_type",
        ),
        nullable=False,
    )
...
class CoverArtType(Base):
    ...
    id = Column(
        ...
        BIGINT,
        ForeignKey(
            apply_schema("cover_art.id", "cover_art_archive"),
            name="cover_art_type_fk_id",
            ondelete="CASCADE",
        ),
        nullable=False,
        primary_key=True,
    ...
    type_id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("art_type.id", "cover_art_archive"),
            name="cover_art_type_fk_type_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class ReleaseGroupCoverArt(Base):
    ...
    release_group_id = Column(
        ...
        ForeignKey(
            apply_schema("release_group.id", "musicbrainz"),
            name="release_group_cover_art_fk_release_group",
        ),
        nullable=False,
        primary_key=True,
    )
    release_id = Column(
        ...
        ForeignKey(
            apply_schema("release.id", "musicbrainz"),
            name="release_group_cover_art_fk_release",
        ),
        nullable=False,
    )
...
class LinkAreaAreaExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_area_area.id", "musicbrainz"),
            name="l_area_area_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkAreaArtistExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_area_artist.id", "musicbrainz"),
            name="l_area_artist_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkAreaEventExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_area_event.id", "musicbrainz"),
            name="l_area_event_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkAreaGenreExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_area_genre.id", "musicbrainz"),
            name="l_area_genre_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkAreaInstrumentExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_area_instrument.id", "musicbrainz"),
            name="l_area_instrument_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkAreaLabelExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_area_label.id", "musicbrainz"),
            name="l_area_label_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkAreaMoodExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_area_mood.id", "musicbrainz"),
            name="l_area_mood_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkAreaPlaceExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_area_place.id", "musicbrainz"),
            name="l_area_place_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkAreaRecordingExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_area_recording.id", "musicbrainz"),
            name="l_area_recording_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkAreaReleaseExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_area_release.id", "musicbrainz"),
            name="l_area_release_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkAreaReleaseGroupExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_area_release_group.id", "musicbrainz"),
            name="l_area_release_group_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkAreaURLExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_area_url.id", "musicbrainz"),
            name="l_area_url_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkAreaWorkExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_area_work.id", "musicbrainz"),
            name="l_area_work_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkArtistArtistExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_artist_artist.id", "musicbrainz"),
            name="l_artist_artist_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkArtistEventExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_artist_event.id", "musicbrainz"),
            name="l_artist_event_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkArtistGenreExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_artist_genre.id", "musicbrainz"),
            name="l_artist_genre_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkArtistInstrumentExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_artist_instrument.id", "musicbrainz"),
            name="l_artist_instrument_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkArtistLabelExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_artist_label.id", "musicbrainz"),
            name="l_artist_label_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkArtistMoodExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_artist_mood.id", "musicbrainz"),
            name="l_artist_mood_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkArtistPlaceExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_artist_place.id", "musicbrainz"),
            name="l_artist_place_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkArtistRecordingExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_artist_recording.id", "musicbrainz"),
            name="l_artist_recording_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkArtistReleaseExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_artist_release.id", "musicbrainz"),
            name="l_artist_release_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkArtistReleaseGroupExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_artist_release_group.id", "musicbrainz"),
            name="l_artist_release_group_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkArtistURLExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_artist_url.id", "musicbrainz"),
            name="l_artist_url_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkArtistWorkExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_artist_work.id", "musicbrainz"),
            name="l_artist_work_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkEventEventExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_event_event.id", "musicbrainz"),
            name="l_event_event_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkEventGenreExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_event_genre.id", "musicbrainz"),
            name="l_event_genre_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkEventInstrumentExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_event_instrument.id", "musicbrainz"),
            name="l_event_instrument_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkEventLabelExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_event_label.id", "musicbrainz"),
            name="l_event_label_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkEventMoodExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_event_mood.id", "musicbrainz"),
            name="l_event_mood_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkEventPlaceExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_event_place.id", "musicbrainz"),
            name="l_event_place_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkEventRecordingExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_event_recording.id", "musicbrainz"),
            name="l_event_recording_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkEventReleaseExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_event_release.id", "musicbrainz"),
            name="l_event_release_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkEventReleaseGroupExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_event_release_group.id", "musicbrainz"),
            name="l_event_release_group_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkEventSeriesExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_event_series.id", "musicbrainz"),
            name="l_event_series_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkEventURLExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_event_url.id", "musicbrainz"),
            name="l_event_url_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkEventWorkExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_event_work.id", "musicbrainz"),
            name="l_event_work_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkGenreGenreExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_genre_genre.id", "musicbrainz"),
            name="l_genre_genre_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkGenreInstrumentExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_genre_instrument.id", "musicbrainz"),
            name="l_genre_instrument_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkGenreLabelExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_genre_label.id", "musicbrainz"),
            name="l_genre_label_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkGenreMoodExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_genre_mood.id", "musicbrainz"),
            name="l_genre_mood_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkGenrePlaceExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_genre_place.id", "musicbrainz"),
            name="l_genre_place_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkGenreRecordingExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_genre_recording.id", "musicbrainz"),
            name="l_genre_recording_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkGenreReleaseExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_genre_release.id", "musicbrainz"),
            name="l_genre_release_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkGenreReleaseGroupExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_genre_release_group.id", "musicbrainz"),
            name="l_genre_release_group_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkGenreSeriesExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_genre_series.id", "musicbrainz"),
            name="l_genre_series_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkGenreURLExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_genre_url.id", "musicbrainz"),
            name="l_genre_url_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkGenreWorkExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_genre_work.id", "musicbrainz"),
            name="l_genre_work_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkInstrumentInstrumentExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_instrument_instrument.id", "musicbrainz"),
            name="l_instrument_instrument_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkInstrumentLabelExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_instrument_label.id", "musicbrainz"),
            name="l_instrument_label_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkInstrumentMoodExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_instrument_mood.id", "musicbrainz"),
            name="l_instrument_mood_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkInstrumentPlaceExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_instrument_place.id", "musicbrainz"),
            name="l_instrument_place_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkInstrumentRecordingExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_instrument_recording.id", "musicbrainz"),
            name="l_instrument_recording_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkInstrumentReleaseExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_instrument_release.id", "musicbrainz"),
            name="l_instrument_release_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkInstrumentReleaseGroupExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_instrument_release_group.id", "musicbrainz"),
            name="l_instrument_release_group_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkInstrumentSeriesExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_instrument_series.id", "musicbrainz"),
            name="l_instrument_series_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkInstrumentURLExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_instrument_url.id", "musicbrainz"),
            name="l_instrument_url_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkInstrumentWorkExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_instrument_work.id", "musicbrainz"),
            name="l_instrument_work_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkLabelLabelExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_label_label.id", "musicbrainz"),
            name="l_label_label_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkLabelMoodExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_label_mood.id", "musicbrainz"),
            name="l_label_mood_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkLabelPlaceExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_label_place.id", "musicbrainz"),
            name="l_label_place_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkLabelRecordingExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_label_recording.id", "musicbrainz"),
            name="l_label_recording_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkLabelReleaseExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_label_release.id", "musicbrainz"),
            name="l_label_release_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkLabelReleaseGroupExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_label_release_group.id", "musicbrainz"),
            name="l_label_release_group_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkLabelURLExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_label_url.id", "musicbrainz"),
            name="l_label_url_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkLabelWorkExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_label_work.id", "musicbrainz"),
            name="l_label_work_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkMoodMoodExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_mood_mood.id", "musicbrainz"),
            name="l_mood_mood_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkMoodPlaceExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_mood_place.id", "musicbrainz"),
            name="l_mood_place_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkMoodRecordingExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_mood_recording.id", "musicbrainz"),
            name="l_mood_recording_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkMoodReleaseExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_mood_release.id", "musicbrainz"),
            name="l_mood_release_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkMoodReleaseGroupExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_mood_release_group.id", "musicbrainz"),
            name="l_mood_release_group_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkMoodSeriesExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_mood_series.id", "musicbrainz"),
            name="l_mood_series_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkMoodURLExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_mood_url.id", "musicbrainz"),
            name="l_mood_url_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkMoodWorkExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_mood_work.id", "musicbrainz"),
            name="l_mood_work_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkPlacePlaceExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_place_place.id", "musicbrainz"),
            name="l_place_place_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkPlaceRecordingExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_place_recording.id", "musicbrainz"),
            name="l_place_recording_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkPlaceReleaseExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_place_release.id", "musicbrainz"),
            name="l_place_release_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkPlaceReleaseGroupExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_place_release_group.id", "musicbrainz"),
            name="l_place_release_group_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkPlaceURLExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_place_url.id", "musicbrainz"),
            name="l_place_url_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkPlaceWorkExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_place_work.id", "musicbrainz"),
            name="l_place_work_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkRecordingRecordingExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_recording_recording.id", "musicbrainz"),
            name="l_recording_recording_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkRecordingReleaseExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_recording_release.id", "musicbrainz"),
            name="l_recording_release_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkRecordingReleaseGroupExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_recording_release_group.id", "musicbrainz"),
            name="l_recording_release_group_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkRecordingURLExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_recording_url.id", "musicbrainz"),
            name="l_recording_url_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkRecordingWorkExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_recording_work.id", "musicbrainz"),
            name="l_recording_work_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkReleaseReleaseExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_release_release.id", "musicbrainz"),
            name="l_release_release_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkReleaseReleaseGroupExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_release_release_group.id", "musicbrainz"),
            name="l_release_release_group_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkReleaseURLExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_release_url.id", "musicbrainz"),
            name="l_release_url_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkReleaseWorkExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_release_work.id", "musicbrainz"),
            name="l_release_work_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkReleaseGroupReleaseGroupExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_release_group_release_group.id", "musicbrainz"),
            name="l_release_group_release_group_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
    ...
    link = relationship(
        "LinkReleaseGroupReleaseGroup", foreign_keys=[id], innerjoin=True
    )
...
class LinkReleaseGroupURLExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_release_group_url.id", "musicbrainz"),
            name="l_release_group_url_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkReleaseGroupWorkExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_release_group_work.id", "musicbrainz"),
            name="l_release_group_work_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkAreaSeriesExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_area_series.id", "musicbrainz"),
            name="l_area_series_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkArtistSeriesExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_artist_series.id", "musicbrainz"),
            name="l_artist_series_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkLabelSeriesExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_label_series.id", "musicbrainz"),
            name="l_label_series_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkPlaceSeriesExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_place_series.id", "musicbrainz"),
            name="l_place_series_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkRecordingSeriesExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_recording_series.id", "musicbrainz"),
            name="l_recording_series_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkReleaseSeriesExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_release_series.id", "musicbrainz"),
            name="l_release_series_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkReleaseGroupSeriesExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_release_group_series.id", "musicbrainz"),
            name="l_release_group_series_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkSeriesSeriesExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_series_series.id", "musicbrainz"),
            name="l_series_series_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkSeriesURLExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_series_url.id", "musicbrainz"),
            name="l_series_url_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkSeriesWorkExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_series_work.id", "musicbrainz"),
            name="l_series_work_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkURLURLExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_url_url.id", "musicbrainz"), name="l_url_url_example_fk_id"
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkURLWorkExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_url_work.id", "musicbrainz"),
            name="l_url_work_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkWorkWorkExample(Base):
    ...
    id = Column(
        ...
        Integer,
        ForeignKey(
            apply_schema("l_work_work.id", "musicbrainz"),
            name="l_work_work_example_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
...
class LinkTypeDocumentation(Base):
    ...
    id = Column(
        ...
        ForeignKey(
            apply_schema("link_type.id", "musicbrainz"),
            name="link_type_documentation_fk_id",
        ),
        nullable=False,
        primary_key=True,
    )
    documentation = Column(String, nullable=False)
    examples_deleted = Column(
        SMALLINT, nullable=False, default=0, server_default=sql.text("0")
    )
